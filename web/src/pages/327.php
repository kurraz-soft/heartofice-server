...
?>
<p>
    Сингх больше привык использовать свою пушку, чем легкий пистолет, поэтому вы оказываетесь на
долю секунды быстрей. Луч бризального пистолета
разрезает воздух, ваш враг без единого звука падает
на пол. Когда вы подходите, чтобы осмотреть тело, вы
...
умер, как и жил, с незапятнанной честью.
</p>
<?php
